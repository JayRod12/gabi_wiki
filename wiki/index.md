...
| [Fernando Gabilondo Manso](fernando_gabilondo.md) | Hijo mayor de Leto y Elvira; preparaba para ingeniero, falleció joven |
...
Esta wiki se construye y mantiene con ayuda de un agente LLM (Claude Code). Las fuentes primarias están en `raw/`. El agente lee las fuentes, extrae información relevante, y actualiza las páginas de la wiki. Consulta el [registro](log.md) para ver el historial de cambios.
